package com.course.javafundamental.collectiontype.hashmap;
...
public class MapPlanet {
    ...
    public static void main (String[] args) {
        ...
        System.out.println("Map planets awal: (Jumlah Array = "+ planets.size() +")");
        ...
        System.out.println();
        System.out.println("Map Planets akhir : (Jumlah Array = " + planets.size() + ")");
